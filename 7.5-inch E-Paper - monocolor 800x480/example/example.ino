...
*/
void loop() {
//This part is about how to display GUI. If you want to see the effect of image, please jump to line 94.
#if 1
...
//Full screen refresh, fast refresh, and partial refresh demostration. If you want to see the effect, please change the next line 0 to 1.
#if 0 
    unsigned char i;
